...
output "primary_cluster_security_group_id" {
  value       = local.create_primary_cluster_sg ? aws_eks_cluster.this[0].vpc_config[0].cluster_security_group_id : data.aws_security_group.primary_cluster_security_group_id[0].arn
  description = "ID of the primary cluster security group"
}

output "additional_cluster_security_group_ids" {
  value       = local.create_additional_cluster_sg ? [for sg in data.aws_security_group.additional_cluster_security_group_id : sg.id] : [for sg in data.aws_security_group.additional_cluster_security_group_id : sg.id]
  description = "IDs of the additional cluster security groups"
}

output "additional_cluster_security_group_arns" {
  value       = local.create_additional_cluster_sg ? [for sg in data.aws_security_group.additional_cluster_security_group_id : sg.arn] : [for sg in data.aws_security_group.additional_cluster_security_group_id : sg.arn]
  description = "ARNs of the additional cluster security groups"
}
################################################################################
# Node Security Group
################################################################################
...
output "cluster_iam_role_name" {
  ...
  value       = try(aws_iam_role.cluster_rol[0].name, null)
}

output "cluster_iam_role_arn" {
  description = "IAM role ARN of the EKS cluster"
  value       = try(aws_iam_role.cluster_rol[0].arn, null)
}
...
output "eni_config_applied" {
  value = kubectl_manifest.eni_config
}
