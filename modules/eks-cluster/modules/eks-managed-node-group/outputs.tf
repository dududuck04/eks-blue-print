...
output "iam_role_name" {
  ...
  value       = module.eks_cluster_node_group_role.aws_iam_role_name
}

output "iam_role_arn" {
  description = "The Amazon Resource Name (ARN) specifying the IAM role"
  value       = module.eks_cluster_node_group_role.aws_iam_role_arn
}

output "iam_role_unique_id" {
  description = "Stable and unique string identifying the IAM role"
  value       = module.eks_cluster_node_group_role.aws_iam_role_unique_id
}
